	...
	var js = {
		...
		general: {
			...
			setupEvents: function(){
				...
				var option1 = ((document.ontouchstart!==null)?'mousedown':'touchstart');
				document.getElementById('option1').addEventListener(option1,function(e){
					js.general.updateSettings1();
				},false);

				var option2 = ((document.ontouchstart!==null)?'mousedown':'touchstart');
				document.getElementById('option2').addEventListener(option2,function(e){
					js.general.updateSettings2();
				},false);

				var option3 = ((document.ontouchstart!==null)?'mousedown':'touchstart');
				document.getElementById('option3').addEventListener(option3,function(e){
			...
			releasePiece: function(){
				if(js.clickedpiece !== -1){
					...
					if(js.pieces.length === 0){
						...
						// alert("YEEET");
						setTimeout(function(){ document.getElementById("share-overlay").classList.toggle("closed"); }, 2000);
					}
				}
			},
